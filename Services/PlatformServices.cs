...
internal static class PlatformServices
{
    ...
    public static ISystemStatsService SystemStats() => new Platform.Windows.WindowsSystemStatsService();
#else
    ...
    public static ISystemStatsService SystemStats() => new Platform.Linux.LinuxSystemStatsService();
#endif
}
